...
이 장에서는 [20장]({% post_url contents/chapter20/21-03-27-20_00_Dual_Methods %})에서 다루었던 ADMM을 조금 더 자세히 다루어보고자 한다. 기본적인 개념은 20장에서 다룬 내용과 깊이에서 큰 차이가 없고, 응용 사례들을 위주로 살펴본다.
