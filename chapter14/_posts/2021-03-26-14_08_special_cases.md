...
3) Dual의 유도를 통한 해결 : Fenchel dual은 $$-f^{*}(-A^{T}v)-b^{T}v$$로 정의되고, strong duality를 만족한다. ([16-03]({% post_url chapter16/21-03-31-16_03_fenchel_duality %})에서 자세히 다루도록 한다.) 간략하게 conjugate function의 정의를 활용하여 dual 문제의 목적함수를 유도해보도록 하자. 여기서의 $$f^{*}$$는 f의 conjugate이다. 
>$$\begin{align}
